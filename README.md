...
* [GraphAware Framework for Embedded Mode, version 2.3.3.37](http://products.graphaware.com/download/framework-embedded/graphaware-embedded-all-2.3.3.37.jar)
* [GraphAware Framework for Server Mode (Community), version 2.3.3.37](http://products.graphaware.com/download/framework-server-community/graphaware-server-community-all-2.3.3.37.jar)
* [GraphAware Framework for Server Mode (Enterprise), version 2.3.3.37](http://products.graphaware.com/download/framework-server-enterprise/graphaware-server-enterprise-all-2.3.3.37.jar)
...
To use the latest development version, just clone this repository and run `mvn clean install`. This will produce 2.3.3.38-SNAPSHOT
