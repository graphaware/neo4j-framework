 ...
 * (using {@link com.graphaware.library.algo.path.PathFinderInput#setCostProperty(String)}).
 * <p/>
...
public class PathFinderInput {
     ...
     * {@link com.graphaware.library.algo.path.SortOrder#LENGTH_ASC_THEN_COST_ASC} or
     * {@link com.graphaware.library.algo.path.SortOrder#LENGTH_ASC_THEN_COST_DESC} is used.
     *
