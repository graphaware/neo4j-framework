...
public class LazyTransactionDataIntegrationTest {
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(previous.getPropertyValues()));
                        ...
                        assertEquals(2, count(current.getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(previous.getStartNode().getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(1, count(r1.getPropertyKeys()));
                        assertEquals(1, count(r1.getPropertyValues()));
                        ...
                        assertEquals(1, count(r3.getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(deletedRel.getEndNode().getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(previous2.getPropertyValues()));
                        ...
                        assertEquals(3, count(current2.getPropertyValues()));
    ...
    public void shouldBeAbleToChangeCurrentChangedRelationshipBeforeCommit() {
        ...
        assertEquals(2, count(r.getPropertyValues()));
