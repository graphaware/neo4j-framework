...
public class FilteredLazyTransactionDataIntegrationTest {
    ...
    public void allInternalMutationsShouldLookLikeNoMutations() {
        ...
        mutateGraph(new InternalTestGraphMutation(), new BeforeCommitCallback() {
            ...
            public void doBeforeCommit(ImprovedTransactionData transactionData) {
                boolean condition = transactionData.mutationsOccurred();
    ...
    public void changedRelationshipsShouldBeCorrectlyIdentified() {
        createTestDatabase();
        final long changedRelId = database.getNodeById(3).getSingleRelationship(withName("R3"), OUTGOING).getId();
        mutateGraph(
                new BeforeCommitCallback() {
                    @Override
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertTrue(transactionData.hasBeenChanged(database.getRelationshipById(changedRelId)));
                        assertFalse(transactionData.getChanged(database.getRelationshipById(changedRelId)).getCurrent().hasProperty("time")); //filtered
                        assertTrue(transactionData.getChanged(database.getRelationshipById(changedRelId)).getCurrent().hasProperty("tags"));
                        assertFalse(transactionData.getChanged(database.getRelationshipById(changedRelId)).getPrevious().hasProperty("time")); //filtered
                        assertFalse(transactionData.getChanged(database.getRelationshipById(changedRelId)).getPrevious().hasProperty("tags"));
                    }
                }
        );
    }
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(3, count(previous.getEndNode().getPropertyValues()));
                        ...
                        assertEquals(1, count(previous.getStartNode().getPropertyValues())); //place filtered
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(current.getEndNode().getPropertyValues()));
    ...
    public void deletedRelationshipsShouldBeCorrectlyIdentified() {
        createTestDatabase();
        final long deletedRelId = database.getNodeById(1).getSingleRelationship(withName("R3"), OUTGOING).getId();
        mutateGraph(
                new BeforeCommitCallback() {
                    @Override
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(0, count(r1.getPropertyValues()));
                        ...
                        assertEquals(0, count(r2.getPropertyKeys()));
                        assertEquals(0, count(r2.getPropertyValues()));
                        ...
                        assertEquals(0, count(r3.getPropertyValues()));
                        ...
                        assertEquals(0, count(r4.getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(3, count(deletedRel.getStartNode().getPropertyValues()));
                        ...
                        assertEquals(1, count(deletedRel.getEndNode().getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        Change<Relationship> change = transactionData.getChanged(database.getRelationshipById(changedRelId));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(3, count(previous1.getPropertyValues()));
                        ...
                        assertEquals(2, count(current1.getPropertyValues()));
                        ...
                        assertEquals(1, count(previous2.getPropertyValues()));
                        ...
                        assertEquals(2, count(current2.getPropertyValues()));
        ...
        mutateGraph(
                new BeforeCommitCallback() {
                    ...
                    public void doBeforeCommit(ImprovedTransactionData transactionData) {
                        ...
                        assertEquals(2, count(deleted.getPropertyValues()));
    ...
    public void shouldBeAbleToChangeCurrentChangedNodeBeforeCommit() {
        ...
        assertEquals(2, count(node.getPropertyValues()));
    ...
    public void shouldChangeNothingIfTxRollsBack() {
        ...
        assertEquals(3, count(r4.getStartNode().getPropertyValues()));
        ...
        assertEquals(2, count(r4.getEndNode().getPropertyValues()));
