...
public class PropertyContainerUtilsTest {
    ...
    public void shouldConvertContainersToMap() {
        Map<Long, Node> nodeMap = propertyContainersToMap(toList(database.getAllNodes()));
    ...
    public void shouldDeleteNodeWithAllRelationships() {
        ...
        new SimpleTransactionExecutor(database).executeInTransaction(new TransactionCallback<Object>() {
            @Override
