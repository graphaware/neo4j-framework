...
/**
 * Unit test for {@link MutableRelationshipImpl}.
 */
public class MutableRelationshipImplTest extends AbstractTest {
    ...
    public void shouldBeConstructedFromRelationshipAndProperties() {
        ...
        Relationship r = database.getNodeById(1).getSingleRelationship(withName("test"), OUTGOING);
        MutablePropertiesImpl p = new MutablePropertiesImpl(Collections.singletonMap("key", "value"));
    ...
    public void shouldBeConstructedFromRelationshipAndPropertiesAsMap() {
        ...
        Relationship r = database.getNodeById(1).getSingleRelationship(withName("test"), OUTGOING);
        MutableRelationship relationship = new MutableRelationshipImpl(r, Collections.singletonMap("key", "value"));
    ...
    public void shouldBeConstructedFromRelationshipTypeAndPropertiesAsMap() {
        MutableRelationship relationship = new MutableRelationshipImpl(withName("test"), Collections.singletonMap("key", "value"));
    ...
    public void propertiesCanBeSet() {
        MutableRelationship<String, ?> relationship = new MutableRelationshipImpl(withName("test"), Collections.singletonMap("key", "value"));
