...
public class MutableDirectedRelationshipImplTest extends AbstractTest {
    ...
    public void shouldBeConstructedFromRelationshipAndNode() {
        ...
        ImmutableDirectedRelationship<Object, ?> relationship = new MutableDirectedRelationshipImpl(database.getNodeById(1).getSingleRelationship(withName("test"), OUTGOING), database.getNodeById(1));
    ...
    public void shouldBeConstructedFromRelationshipNodeAndPropertiesAsMap() {
        ...
        ImmutableDirectedRelationship relationship = new MutableDirectedRelationshipImpl(database.getNodeById(1).getSingleRelationship(withName("test"), OUTGOING), database.getNodeById(1), Collections.<String, Object>singletonMap("key", "value"));
    ...
    public void shouldBeConstructedFromRelationshipTypeDirectionAndPropertiesAsMap() {
        ...
        ImmutableDirectedRelationship relationship = new MutableDirectedRelationshipImpl(withName("test"), OUTGOING, Collections.<String, Object>singletonMap("key", "value"));
    ...
    public void shouldBeConstructedFromAnotherRelationship() {
        ...
        ImmutableDirectedRelationship<Object, ?> relationship = new MutableDirectedRelationshipImpl(new ImmutableDirectedRelationshipImpl(database.getNodeById(1).getSingleRelationship(withName("test"), OUTGOING), database.getNodeById(1)));
    ...
    public void sameRelationshipsShouldBeEqual() {
        ...
        assertTrue(new MutableDirectedRelationshipImpl(withName("test"), INCOMING, Collections.<String, Object>singletonMap("key", "value")).equals(new MutableDirectedRelationshipImpl(withName("test"), INCOMING, Collections.<String, Object>singletonMap("key", "value"))));
    }
    ...
    public void differentRelationshipsShouldNotBeEqual() {
        ...
        assertFalse(new MutableDirectedRelationshipImpl(withName("test"), INCOMING, Collections.<String, Object>singletonMap("key", "value2")).equals(new MutableDirectedRelationshipImpl(withName("test"), INCOMING, Collections.<String, Object>singletonMap("key", "value"))));
    }

    @Test
    public void propertiesCanBeSet() {
        MutableDirectedRelationship<Object, ?> relationship = new MutableDirectedRelationshipImpl(withName("test"), OUTGOING, Collections.<String, Object>singletonMap("key", "value"));
