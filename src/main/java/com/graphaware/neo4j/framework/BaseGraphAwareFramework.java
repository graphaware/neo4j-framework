...
/**
 * Framework that delegates to registered {@link com.graphaware.neo4j.framework.GraphAwareModule}s to perform useful work. There must be exactly one
 ...
 * {@link com.graphaware.neo4j.tx.event.api.ImprovedTransactionData} and lets registered {@link com.graphaware.neo4j.framework.GraphAwareModule}s
 ...
 * <p/>
 * Every new {@link com.graphaware.neo4j.framework.GraphAwareModule} and every {@link com.graphaware.neo4j.framework.GraphAwareModule} whose configuration has changed since the last
 ...
 * it has been detected that something is out-of-sync (module threw a {@link com.graphaware.neo4j.framework.NeedsInitializationException}).
 * <p/>
...
public abstract class BaseGraphAwareFramework implements TransactionEventHandler<Void>, KernelEventHandler {
    ...
    /**
     * Register a {@link com.graphaware.neo4j.framework.GraphAwareModule}. Note that modules are delegated to in the order they are registered.
     *
    ...
    /**
     * Register a {@link com.graphaware.neo4j.framework.GraphAwareModule} and optionally force its (re-)initialization.
     * <p/>
     ...
     * {@link com.graphaware.neo4j.framework.config.FrameworkConfiguration#GA_PREFIX}{@link #CORE}_{@link GraphAwareModule#getId()} as key and one of the
     * following as value:
    ...
    /**
     * Get properties starting with {@link com.graphaware.neo4j.framework.config.FrameworkConfiguration#GA_PREFIX} + {@link #CORE} from a node.
     *
     ...
     *
     * @return root node.
     * @throws org.neo4j.graphdb.NotFoundException if root not found.
     */
