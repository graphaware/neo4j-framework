...
/**
 * {@link BatchExecutor} which expects the {@link #execute()} method to only ever be called at most once.
 * After that, it must be discarded.
 */
public abstract class DisposableBatchExecutor implements BatchExecutor {
