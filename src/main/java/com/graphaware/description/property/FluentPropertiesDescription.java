 ...
 * new instances with different {@link Predicate}s can be constructed using the
 * {@link #with(String, com.graphaware.description.predicate.Predicate)} method.
 */
public interface FluentPropertiesDescription extends PropertiesDescription {
     ...
     */
    FluentPropertiesDescription with(String propertyKey, Predicate predicate);
}
