 ...
 * new instances with different {@link PropertiesDescription}s can be constructed using the
 * {@link #with(String, Predicate)} method.
 */
public interface FluentRelationshipDescription extends RelationshipDescription {
     ...
     */
    FluentRelationshipDescription with(String propertyKey, Predicate predicate);
}
