...
/**
 * Simple implementation of {@link com.graphaware.propertycontainer.dto.common.relationship.MutableRelationship} with {@link String}
 * property values.
 */
public class MutableRelationshipImpl extends BaseRelationship<String, MutableProperties<String>> implements MutableRelationship<String, MutableProperties<String>> {
     ...
     */
    public MutableRelationshipImpl(Relationship relationship, MutableProperties<String> properties) {
     ...
     * @param properties   to use as if they were in the relationship.
     */
    public MutableRelationshipImpl(Relationship relationship, Map<String, String> properties) {
        super(relationship, properties);
    }
     ...
     */
    public MutableRelationshipImpl(RelationshipType type, MutableProperties<String> properties) {
     ...
     * @param properties props.
     */
    public MutableRelationshipImpl(RelationshipType type, Map<String, String> properties) {
        super(type, properties);
    }
     ...
     */
    public MutableRelationshipImpl(HasTypeAndProperties<String, ?> relationship) {
        super(relationship);
    }
