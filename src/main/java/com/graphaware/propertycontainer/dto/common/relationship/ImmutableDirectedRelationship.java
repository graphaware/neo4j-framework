...
/**
 * An {@link ImmutableRelationship} with a direction from a {@link org.neo4j.graphdb.Node}'s point of view.
 *
 ...
 */
public interface ImmutableDirectedRelationship<V, P extends ImmutableProperties<V>> extends ImmutableRelationship<V, P>, HasTypeDirectionAndProperties<V, P> {
}
