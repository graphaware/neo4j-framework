 ...
 * holding {@link ImmutableProperties} with {@link Object} value representations.
 */
public class ImmutableDirectedRelationshipImpl extends BaseDirectedRelationship<Object, ImmutableProperties<Object>> implements ImmutableDirectedRelationship<Object, ImmutableProperties<Object>> {
     ...
     */
    public ImmutableDirectedRelationshipImpl(Relationship relationship, Node pointOfView, ImmutableProperties<Object> properties) {
     ...
     * @param properties   to use as if they were in the relationship.
     */
    public ImmutableDirectedRelationshipImpl(Relationship relationship, Node pointOfView, Map<String, Object> properties) {
        super(relationship, pointOfView, properties);
    }
     ...
     */
    public ImmutableDirectedRelationshipImpl(RelationshipType type, Direction direction, ImmutableProperties<Object> properties) {
     ...
     * @param properties props.
     */
    public ImmutableDirectedRelationshipImpl(RelationshipType type, Direction direction, Map<String, Object> properties) {
        super(type, direction, properties);
    }
     ...
     */
    public ImmutableDirectedRelationshipImpl(ImmutableDirectedRelationship<Object, ?> relationship) {
        super(relationship);
    }
