...
/**
 * An implementation of {@link RelationshipPropertyInclusionPolicy} that is entirely configurable using its fluent interface.
 */
public class IncludeRelationshipProperties extends BaseIncludeProperties<IncludeRelationshipProperties, Relationship> implements RelationshipPropertyInclusionPolicy {
    ...
    protected IncludeRelationshipProperties(String key) {
        super(key);
    }
