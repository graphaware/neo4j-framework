...
/**
 * An implementation of {@link NodePropertyInclusionPolicy} that is entirely configurable using its fluent interface.
 */
public class IncludeNodeProperties extends BaseIncludeProperties<IncludeNodeProperties, Node> implements NodePropertyInclusionPolicy {
    ...
    protected IncludeNodeProperties(String key) {
        super(key);
    }
