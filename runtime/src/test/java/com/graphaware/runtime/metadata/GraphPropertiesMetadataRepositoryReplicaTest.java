...
public class GraphPropertiesMetadataRepositoryReplicaTest {

	private CoreCausalClusterIntegrationTestUtils clusterIntegrationTestUtils;
	private ReplicaCausalClusterIntegrationTestUtils replicaIntegrationTestUtils;
    ...
    public void setUp() throws Exception{
    	...
    	replicaIntegrationTestUtils = new ReplicaCausalClusterIntegrationTestUtils();
    	replicaIntegrationTestUtils.setUpDatabases(1);
    }
    
    @After
    public void tearDown(){
    	replicaIntegrationTestUtils.shutdownDatabases();
